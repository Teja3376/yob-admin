...
export const orderListColumn = (router: ReturnType<typeof useRouter>): ColumnDef<OrderListTableProps>[] => [
    {
        header: "Order ID",
        accessorKey: "_id",
        cell: ({ row }) => {
            ...
            return (
                <div className="flex items-center gap-2">
                    ...
                    <CopyIcon className="cursor-pointer" size={16} onClick={() => handleCopy(orderId)} />
                </div>
            );
        },
    },
    {
        ...
        cell: ({ row }) => {
            const issuerName = row.original.issuer.firstName + " " + row.original.issuer.lastName;
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return (
                <div className="flex items-center gap-2">
                    <span className="text-gray-900"><StatusBadge status={status as OrderStatus} /></span>
                </div>
            )
        }
    },
